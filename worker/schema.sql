...
CREATE TABLE IF NOT EXISTS resumes (
  ...
  ai_evaluation TEXT,
  hr_review TEXT,
  hr_disposition TEXT DEFAULT 'pending',
  business_screening_status TEXT DEFAULT 'not_ready',
  business_screening_remark TEXT DEFAULT '',
  business_screened_at TEXT,
  business_screened_by TEXT DEFAULT '',
  business_screening_batch_id TEXT DEFAULT '',
...
CREATE TABLE IF NOT EXISTS system_configs (
  ...
  -- AI 模型多配置降级：llm2_* / llm3_* / llm4_* 为备用配置，优先级低于 llm_*
  llm2_base_url TEXT,
  llm2_model TEXT,
  llm2_api_key TEXT,
  llm3_base_url TEXT,
...
-- Real Excel archives are kept separately from immutable JSON dashboard snapshots.
